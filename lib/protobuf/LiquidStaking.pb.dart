...
class Output extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Output', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.LiquidStaking.Proto'), createEmptyInstance: create)
    ...
    ..aOM<$7.SigningInput>(2, _omitFieldNames ? '' : 'ethereum', subBuilder: $7.SigningInput.create)
    ..aOM<$8.SigningInput>(3, _omitFieldNames ? '' : 'cosmos', subBuilder: $8.SigningInput.create)
    ..aOM<$9.SigningInput>(4, _omitFieldNames ? '' : 'aptos', subBuilder: $9.SigningInput.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $7.SigningInput get ethereum => $_getN(1);
  @$pb.TagNumber(2)
  set ethereum($7.SigningInput v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasEthereum() => $_has(1);
  @$pb.TagNumber(2)
  void clearEthereum() => clearField(2);
  @$pb.TagNumber(2)
  $7.SigningInput ensureEthereum() => $_ensure(1);

  @$pb.TagNumber(3)
  $8.SigningInput get cosmos => $_getN(2);
  @$pb.TagNumber(3)
  set cosmos($8.SigningInput v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasCosmos() => $_has(2);
  @$pb.TagNumber(3)
  void clearCosmos() => clearField(3);
  @$pb.TagNumber(3)
  $8.SigningInput ensureCosmos() => $_ensure(2);

  @$pb.TagNumber(4)
  $9.SigningInput get aptos => $_getN(3);
  @$pb.TagNumber(4)
  set aptos($9.SigningInput v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasAptos() => $_has(3);
  @$pb.TagNumber(4)
  void clearAptos() => clearField(4);
  @$pb.TagNumber(4)
  $9.SigningInput ensureAptos() => $_ensure(3);
}
