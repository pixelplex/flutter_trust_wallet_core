...
class Balance_Transfer extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Balance.Transfer', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.Polymesh.Proto'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'toAddress')
    ..a<$core.List<$core.int>>(2, _omitFieldNames ? '' : 'value', $pb.PbFieldType.OY)
    ..aOS(3, _omitFieldNames ? '' : 'memo')
    ..aOM<$10.CallIndices>(4, _omitFieldNames ? '' : 'callIndices', subBuilder: $10.CallIndices.create)
  ...
  @$pb.TagNumber(4)
  set callIndices($10.CallIndices v) { setField(4, v); }
  @$pb.TagNumber(4)
...
class Balance extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Balance', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.Polymesh.Proto'), createEmptyInstance: create)
    ..oo(0, [1])
...
class Staking_Bond extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Staking.Bond', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.Polymesh.Proto'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'controller')
    ..a<$core.List<$core.int>>(2, _omitFieldNames ? '' : 'value', $pb.PbFieldType.OY)
    ..e<$10.RewardDestination>(3, _omitFieldNames ? '' : 'rewardDestination', $pb.PbFieldType.OE, defaultOrMaker: $10.RewardDestination.STAKED, valueOf: $10.RewardDestination.valueOf, enumValues: $10.RewardDestination.values)
    ..aOM<$10.CallIndices>(4, _omitFieldNames ? '' : 'callIndices', subBuilder: $10.CallIndices.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  set rewardDestination($10.RewardDestination v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class Staking_BondExtra extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Staking.BondExtra', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.Polymesh.Proto'), createEmptyInstance: create)
    ..a<$core.List<$core.int>>(1, _omitFieldNames ? '' : 'value', $pb.PbFieldType.OY)
    ..aOM<$10.CallIndices>(2, _omitFieldNames ? '' : 'callIndices', subBuilder: $10.CallIndices.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  set callIndices($10.CallIndices v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class Staking_Unbond extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Staking.Unbond', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.Polymesh.Proto'), createEmptyInstance: create)
    ..a<$core.List<$core.int>>(1, _omitFieldNames ? '' : 'value', $pb.PbFieldType.OY)
    ..aOM<$10.CallIndices>(2, _omitFieldNames ? '' : 'callIndices', subBuilder: $10.CallIndices.create)
    ..hasRequiredFields = false
  ;
...
class Staking_Rebond extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Staking.Rebond', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.Polymesh.Proto'), createEmptyInstance: create)
    ..a<$core.List<$core.int>>(1, _omitFieldNames ? '' : 'value', $pb.PbFieldType.OY)
    ..aOM<$10.CallIndices>(2, _omitFieldNames ? '' : 'callIndices', subBuilder: $10.CallIndices.create)
    ..hasRequiredFields = false
  ;
...
class Staking_WithdrawUnbonded extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Staking.WithdrawUnbonded', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.Polymesh.Proto'), createEmptyInstance: create)
...
class Staking_Nominate extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Staking.Nominate', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.Polymesh.Proto'), createEmptyInstance: create)
...
class Staking_Chill extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Staking.Chill', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.Polymesh.Proto'), createEmptyInstance: create)
    ..aOM<$10.CallIndices>(1, _omitFieldNames ? '' : 'callIndices', subBuilder: $10.CallIndices.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  set callIndices($10.CallIndices v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class Staking extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Staking', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.Polymesh.Proto'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3, 4, 5, 6, 7])
    ..aOM<Staking_Bond>(1, _omitFieldNames ? '' : 'bond', subBuilder: Staking_Bond.create)
    ..aOM<Staking_BondExtra>(2, _omitFieldNames ? '' : 'bondExtra', subBuilder: Staking_BondExtra.create)
    ..aOM<Staking_Unbond>(3, _omitFieldNames ? '' : 'unbond', subBuilder: Staking_Unbond.create)
    ..aOM<Staking_WithdrawUnbonded>(4, _omitFieldNames ? '' : 'withdrawUnbonded', subBuilder: Staking_WithdrawUnbonded.create)
    ..aOM<Staking_Nominate>(5, _omitFieldNames ? '' : 'nominate', subBuilder: Staking_Nominate.create)
    ..aOM<Staking_Chill>(6, _omitFieldNames ? '' : 'chill', subBuilder: Staking_Chill.create)
    ..aOM<Staking_Rebond>(7, _omitFieldNames ? '' : 'rebond', subBuilder: Staking_Rebond.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(7)
  set rebond(Staking_Rebond v) { setField(7, v); }
  @$pb.TagNumber(7)
...
class IdentityId extends $pb.GeneratedMessage {
  ...
  IdentityId._() : super();
  factory IdentityId.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory IdentityId.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'IdentityId', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.Polymesh.Proto'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  IdentityId copyWith(void Function(IdentityId) updates) => super.copyWith((message) => updates(message as IdentityId)) as IdentityId;
  ...
  @$core.pragma('dart2js:noInline')
  static IdentityId getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<IdentityId>(create);
...
class AssetId extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AssetId', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.Polymesh.Proto'), createEmptyInstance: create)
    ..a<$core.List<$core.int>>(1, _omitFieldNames ? '' : 'id', $pb.PbFieldType.OY)
    ..hasRequiredFields = false
  ;
...
class PortfolioId extends $pb.GeneratedMessage {
  ...
  PortfolioId._() : super();
  factory PortfolioId.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory PortfolioId.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PortfolioId', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.Polymesh.Proto'), createEmptyInstance: create)
    ..aOM<IdentityId>(1, _omitFieldNames ? '' : 'identity', subBuilder: IdentityId.create)
    ..aOB(2, _omitFieldNames ? '' : 'default')
    ..a<$fixnum.Int64>(3, _omitFieldNames ? '' : 'user', $pb.PbFieldType.OU6, defaultOrMaker: $fixnum.Int64.ZERO)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PortfolioId copyWith(void Function(PortfolioId) updates) => super.copyWith((message) => updates(message as PortfolioId)) as PortfolioId;
  ...
  @$core.pragma('dart2js:noInline')
  static PortfolioId getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<PortfolioId>(create);
  ...
  @$pb.TagNumber(1)
  set identity(IdentityId v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(3)
  set user($fixnum.Int64 v) { $_setInt64(2, v); }
  @$pb.TagNumber(3)
...
class SecondaryKeyPermissions_AssetPermissions extends $pb.GeneratedMessage {
  ...
  factory SecondaryKeyPermissions_AssetPermissions.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory SecondaryKeyPermissions_AssetPermissions.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SecondaryKeyPermissions.AssetPermissions', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.Polymesh.Proto'), createEmptyInstance: create)
    ..e<SecondaryKeyPermissions_RestrictionKind>(1, _omitFieldNames ? '' : 'kind', $pb.PbFieldType.OE, defaultOrMaker: SecondaryKeyPermissions_RestrictionKind.Whole, valueOf: SecondaryKeyPermissions_RestrictionKind.valueOf, enumValues: SecondaryKeyPermissions_RestrictionKind.values)
    ..pc<AssetId>(2, _omitFieldNames ? '' : 'assets', $pb.PbFieldType.PM, subBuilder: AssetId.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  SecondaryKeyPermissions_AssetPermissions clone() => SecondaryKeyPermissions_AssetPermissions()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SecondaryKeyPermissions_AssetPermissions copyWith(void Function(SecondaryKeyPermissions_AssetPermissions) updates) => super.copyWith((message) => updates(message as SecondaryKeyPermissions_AssetPermissions)) as SecondaryKeyPermissions_AssetPermissions;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static SecondaryKeyPermissions_AssetPermissions create() => SecondaryKeyPermissions_AssetPermissions._();
  SecondaryKeyPermissions_AssetPermissions createEmptyInstance() => create();
  static $pb.PbList<SecondaryKeyPermissions_AssetPermissions> createRepeated() => $pb.PbList<SecondaryKeyPermissions_AssetPermissions>();
  @$core.pragma('dart2js:noInline')
  static SecondaryKeyPermissions_AssetPermissions getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<SecondaryKeyPermissions_AssetPermissions>(create);
  static SecondaryKeyPermissions_AssetPermissions? _defaultInstance;

  @$pb.TagNumber(1)
  SecondaryKeyPermissions_RestrictionKind get kind => $_getN(0);
  @$pb.TagNumber(1)
  set kind(SecondaryKeyPermissions_RestrictionKind v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class SecondaryKeyPermissions_PortfolioPermissions extends $pb.GeneratedMessage {
  ...
  factory SecondaryKeyPermissions_PortfolioPermissions.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory SecondaryKeyPermissions_PortfolioPermissions.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SecondaryKeyPermissions.PortfolioPermissions', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.Polymesh.Proto'), createEmptyInstance: create)
    ..e<SecondaryKeyPermissions_RestrictionKind>(1, _omitFieldNames ? '' : 'kind', $pb.PbFieldType.OE, defaultOrMaker: SecondaryKeyPermissions_RestrictionKind.Whole, valueOf: SecondaryKeyPermissions_RestrictionKind.valueOf, enumValues: SecondaryKeyPermissions_RestrictionKind.values)
    ..pc<PortfolioId>(2, _omitFieldNames ? '' : 'portfolios', $pb.PbFieldType.PM, subBuilder: PortfolioId.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  SecondaryKeyPermissions_PortfolioPermissions clone() => SecondaryKeyPermissions_PortfolioPermissions()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SecondaryKeyPermissions_PortfolioPermissions copyWith(void Function(SecondaryKeyPermissions_PortfolioPermissions) updates) => super.copyWith((message) => updates(message as SecondaryKeyPermissions_PortfolioPermissions)) as SecondaryKeyPermissions_PortfolioPermissions;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static SecondaryKeyPermissions_PortfolioPermissions create() => SecondaryKeyPermissions_PortfolioPermissions._();
  SecondaryKeyPermissions_PortfolioPermissions createEmptyInstance() => create();
  static $pb.PbList<SecondaryKeyPermissions_PortfolioPermissions> createRepeated() => $pb.PbList<SecondaryKeyPermissions_PortfolioPermissions>();
  @$core.pragma('dart2js:noInline')
  static SecondaryKeyPermissions_PortfolioPermissions getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<SecondaryKeyPermissions_PortfolioPermissions>(create);
...
class SecondaryKeyPermissions_PalletPermissions extends $pb.GeneratedMessage {
  ...
  factory SecondaryKeyPermissions_PalletPermissions.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory SecondaryKeyPermissions_PalletPermissions.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SecondaryKeyPermissions.PalletPermissions', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.Polymesh.Proto'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'palletName')
    ..e<SecondaryKeyPermissions_RestrictionKind>(2, _omitFieldNames ? '' : 'kind', $pb.PbFieldType.OE, defaultOrMaker: SecondaryKeyPermissions_RestrictionKind.Whole, valueOf: SecondaryKeyPermissions_RestrictionKind.valueOf, enumValues: SecondaryKeyPermissions_RestrictionKind.values)
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  SecondaryKeyPermissions_PalletPermissions clone() => SecondaryKeyPermissions_PalletPermissions()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SecondaryKeyPermissions_PalletPermissions copyWith(void Function(SecondaryKeyPermissions_PalletPermissions) updates) => super.copyWith((message) => updates(message as SecondaryKeyPermissions_PalletPermissions)) as SecondaryKeyPermissions_PalletPermissions;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static SecondaryKeyPermissions_PalletPermissions create() => SecondaryKeyPermissions_PalletPermissions._();
  SecondaryKeyPermissions_PalletPermissions createEmptyInstance() => create();
  static $pb.PbList<SecondaryKeyPermissions_PalletPermissions> createRepeated() => $pb.PbList<SecondaryKeyPermissions_PalletPermissions>();
  @$core.pragma('dart2js:noInline')
  static SecondaryKeyPermissions_PalletPermissions getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<SecondaryKeyPermissions_PalletPermissions>(create);
  static SecondaryKeyPermissions_PalletPermissions? _defaultInstance;

  @$pb.TagNumber(1)
  $core.String get palletName => $_getSZ(0);
  @$pb.TagNumber(1)
  set palletName($core.String v) { $_setString(0, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set kind(SecondaryKeyPermissions_RestrictionKind v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class SecondaryKeyPermissions_ExtrinsicPermissions extends $pb.GeneratedMessage {
  ...
  factory SecondaryKeyPermissions_ExtrinsicPermissions.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory SecondaryKeyPermissions_ExtrinsicPermissions.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SecondaryKeyPermissions.ExtrinsicPermissions', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.Polymesh.Proto'), createEmptyInstance: create)
    ..e<SecondaryKeyPermissions_RestrictionKind>(1, _omitFieldNames ? '' : 'kind', $pb.PbFieldType.OE, defaultOrMaker: SecondaryKeyPermissions_RestrictionKind.Whole, valueOf: SecondaryKeyPermissions_RestrictionKind.valueOf, enumValues: SecondaryKeyPermissions_RestrictionKind.values)
    ..pc<SecondaryKeyPermissions_PalletPermissions>(2, _omitFieldNames ? '' : 'pallets', $pb.PbFieldType.PM, subBuilder: SecondaryKeyPermissions_PalletPermissions.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  SecondaryKeyPermissions_ExtrinsicPermissions clone() => SecondaryKeyPermissions_ExtrinsicPermissions()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SecondaryKeyPermissions_ExtrinsicPermissions copyWith(void Function(SecondaryKeyPermissions_ExtrinsicPermissions) updates) => super.copyWith((message) => updates(message as SecondaryKeyPermissions_ExtrinsicPermissions)) as SecondaryKeyPermissions_ExtrinsicPermissions;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static SecondaryKeyPermissions_ExtrinsicPermissions create() => SecondaryKeyPermissions_ExtrinsicPermissions._();
  SecondaryKeyPermissions_ExtrinsicPermissions createEmptyInstance() => create();
  static $pb.PbList<SecondaryKeyPermissions_ExtrinsicPermissions> createRepeated() => $pb.PbList<SecondaryKeyPermissions_ExtrinsicPermissions>();
  @$core.pragma('dart2js:noInline')
  static SecondaryKeyPermissions_ExtrinsicPermissions getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<SecondaryKeyPermissions_ExtrinsicPermissions>(create);
  ...
  @$pb.TagNumber(2)
  $core.List<SecondaryKeyPermissions_PalletPermissions> get pallets => $_getList(1);
}
...
class SecondaryKeyPermissions extends $pb.GeneratedMessage {
  ...
  factory SecondaryKeyPermissions.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory SecondaryKeyPermissions.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SecondaryKeyPermissions', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.Polymesh.Proto'), createEmptyInstance: create)
    ..aOM<SecondaryKeyPermissions_AssetPermissions>(1, _omitFieldNames ? '' : 'asset', subBuilder: SecondaryKeyPermissions_AssetPermissions.create)
    ..aOM<SecondaryKeyPermissions_ExtrinsicPermissions>(2, _omitFieldNames ? '' : 'extrinsic', subBuilder: SecondaryKeyPermissions_ExtrinsicPermissions.create)
    ..aOM<SecondaryKeyPermissions_PortfolioPermissions>(3, _omitFieldNames ? '' : 'portfolio', subBuilder: SecondaryKeyPermissions_PortfolioPermissions.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  SecondaryKeyPermissions clone() => SecondaryKeyPermissions()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SecondaryKeyPermissions copyWith(void Function(SecondaryKeyPermissions) updates) => super.copyWith((message) => updates(message as SecondaryKeyPermissions)) as SecondaryKeyPermissions;
  ...
  static $pb.PbList<SecondaryKeyPermissions> createRepeated() => $pb.PbList<SecondaryKeyPermissions>();
  @$core.pragma('dart2js:noInline')
  static SecondaryKeyPermissions getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<SecondaryKeyPermissions>(create);
  ...
  @$pb.TagNumber(1)
  set asset(SecondaryKeyPermissions_AssetPermissions v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set extrinsic(SecondaryKeyPermissions_ExtrinsicPermissions v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set portfolio(SecondaryKeyPermissions_PortfolioPermissions v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class Identity_JoinIdentityAsKey extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Identity.JoinIdentityAsKey', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.Polymesh.Proto'), createEmptyInstance: create)
    ..aOM<$10.CallIndices>(1, _omitFieldNames ? '' : 'callIndices', subBuilder: $10.CallIndices.create)
...
class Identity_LeaveIdentityAsKey extends $pb.GeneratedMessage {
  ...
  factory Identity_LeaveIdentityAsKey.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory Identity_LeaveIdentityAsKey.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Identity.LeaveIdentityAsKey', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.Polymesh.Proto'), createEmptyInstance: create)
    ..aOM<$10.CallIndices>(1, _omitFieldNames ? '' : 'callIndices', subBuilder: $10.CallIndices.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  Identity_LeaveIdentityAsKey clone() => Identity_LeaveIdentityAsKey()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Identity_LeaveIdentityAsKey copyWith(void Function(Identity_LeaveIdentityAsKey) updates) => super.copyWith((message) => updates(message as Identity_LeaveIdentityAsKey)) as Identity_LeaveIdentityAsKey;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static Identity_LeaveIdentityAsKey create() => Identity_LeaveIdentityAsKey._();
  Identity_LeaveIdentityAsKey createEmptyInstance() => create();
  static $pb.PbList<Identity_LeaveIdentityAsKey> createRepeated() => $pb.PbList<Identity_LeaveIdentityAsKey>();
  @$core.pragma('dart2js:noInline')
  static Identity_LeaveIdentityAsKey getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<Identity_LeaveIdentityAsKey>(create);
...
enum Identity_AddAuthorization_Authorization_AuthOneof {
  joinIdentity, 
  notSet
}
...
class Identity_AddAuthorization_Authorization extends $pb.GeneratedMessage {
  ...
  factory Identity_AddAuthorization_Authorization.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory Identity_AddAuthorization_Authorization.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static const $core.Map<$core.int, Identity_AddAuthorization_Authorization_AuthOneof> _Identity_AddAuthorization_Authorization_AuthOneofByTag = {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Identity.AddAuthorization.Authorization', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.Polymesh.Proto'), createEmptyInstance: create)
    ..oo(0, [6])
    ..aOM<SecondaryKeyPermissions>(6, _omitFieldNames ? '' : 'joinIdentity', subBuilder: SecondaryKeyPermissions.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  Identity_AddAuthorization_Authorization clone() => Identity_AddAuthorization_Authorization()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Identity_AddAuthorization_Authorization copyWith(void Function(Identity_AddAuthorization_Authorization) updates) => super.copyWith((message) => updates(message as Identity_AddAuthorization_Authorization)) as Identity_AddAuthorization_Authorization;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static Identity_AddAuthorization_Authorization create() => Identity_AddAuthorization_Authorization._();
  Identity_AddAuthorization_Authorization createEmptyInstance() => create();
  static $pb.PbList<Identity_AddAuthorization_Authorization> createRepeated() => $pb.PbList<Identity_AddAuthorization_Authorization>();
  @$core.pragma('dart2js:noInline')
  static Identity_AddAuthorization_Authorization getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<Identity_AddAuthorization_Authorization>(create);
  static Identity_AddAuthorization_Authorization? _defaultInstance;

  Identity_AddAuthorization_Authorization_AuthOneof whichAuthOneof() => _Identity_AddAuthorization_Authorization_AuthOneofByTag[$_whichOneof(0)]!;
  ...
  @$pb.TagNumber(6)
  set joinIdentity(SecondaryKeyPermissions v) { setField(6, v); }
  @$pb.TagNumber(6)
...
class Identity_AddAuthorization extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Identity.AddAuthorization', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.Polymesh.Proto'), createEmptyInstance: create)
    ..aOM<$10.CallIndices>(1, _omitFieldNames ? '' : 'callIndices', subBuilder: $10.CallIndices.create)
    ..aOS(2, _omitFieldNames ? '' : 'target')
    ..aOM<Identity_AddAuthorization_Authorization>(3, _omitFieldNames ? '' : 'authorization', subBuilder: Identity_AddAuthorization_Authorization.create)
  ...
  @$pb.TagNumber(3)
  set authorization(Identity_AddAuthorization_Authorization v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class Identity extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Identity', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.Polymesh.Proto'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ...
    ..aOM<Identity_LeaveIdentityAsKey>(3, _omitFieldNames ? '' : 'leaveIdentityAsKey', subBuilder: Identity_LeaveIdentityAsKey.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  set leaveIdentityAsKey(Identity_LeaveIdentityAsKey v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class Utility_Batch extends $pb.GeneratedMessage {
  ...
  factory Utility_Batch.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory Utility_Batch.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Utility.Batch', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.Polymesh.Proto'), createEmptyInstance: create)
    ..e<Utility_BatchKind>(1, _omitFieldNames ? '' : 'kind', $pb.PbFieldType.OE, defaultOrMaker: Utility_BatchKind.StopOnError, valueOf: Utility_BatchKind.valueOf, enumValues: Utility_BatchKind.values)
    ..pc<RuntimeCall>(2, _omitFieldNames ? '' : 'calls', $pb.PbFieldType.PM, subBuilder: RuntimeCall.create)
    ..aOM<$10.CallIndices>(3, _omitFieldNames ? '' : 'callIndices', subBuilder: $10.CallIndices.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Utility_Batch copyWith(void Function(Utility_Batch) updates) => super.copyWith((message) => updates(message as Utility_Batch)) as Utility_Batch;
  ...
  static $pb.PbList<Utility_Batch> createRepeated() => $pb.PbList<Utility_Batch>();
  @$core.pragma('dart2js:noInline')
  static Utility_Batch getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<Utility_Batch>(create);
  ...
  @$pb.TagNumber(1)
  set kind(Utility_BatchKind v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasKind() => $_has(0);
  @$pb.TagNumber(1)
  void clearKind() => clearField(1);
  ...
  @$pb.TagNumber(3)
  set callIndices($10.CallIndices v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class Utility extends $pb.GeneratedMessage {
  ...
  Utility._() : super();
  factory Utility.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory Utility.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static const $core.Map<$core.int, Utility_MessageOneof> _Utility_MessageOneofByTag = {
    1 : Utility_MessageOneof.batch,
    0 : Utility_MessageOneof.notSet
  };
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Utility', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.Polymesh.Proto'), createEmptyInstance: create)
    ..oo(0, [1])
    ..aOM<Utility_Batch>(1, _omitFieldNames ? '' : 'batch', subBuilder: Utility_Batch.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Utility copyWith(void Function(Utility) updates) => super.copyWith((message) => updates(message as Utility)) as Utility;
  ...
  @$core.pragma('dart2js:noInline')
  static Utility getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<Utility>(create);
  static Utility? _defaultInstance;

  Utility_MessageOneof whichMessageOneof() => _Utility_MessageOneofByTag[$_whichOneof(0)]!;
  void clearMessageOneof() => clearField($_whichOneof(0));

  @$pb.TagNumber(1)
  Utility_Batch get batch => $_getN(0);
  @$pb.TagNumber(1)
  set batch(Utility_Batch v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class RuntimeCall extends $pb.GeneratedMessage {
  ...
  RuntimeCall._() : super();
  factory RuntimeCall.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory RuntimeCall.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static const $core.Map<$core.int, RuntimeCall_PalletOneof> _RuntimeCall_PalletOneofByTag = {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RuntimeCall', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.Polymesh.Proto'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3, 4])
    ..aOM<Balance>(1, _omitFieldNames ? '' : 'balanceCall', subBuilder: Balance.create)
    ..aOM<Staking>(2, _omitFieldNames ? '' : 'stakingCall', subBuilder: Staking.create)
    ..aOM<Identity>(3, _omitFieldNames ? '' : 'identityCall', subBuilder: Identity.create)
    ..aOM<Utility>(4, _omitFieldNames ? '' : 'utilityCall', subBuilder: Utility.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  RuntimeCall copyWith(void Function(RuntimeCall) updates) => super.copyWith((message) => updates(message as RuntimeCall)) as RuntimeCall;
  ...
  @$core.pragma('dart2js:noInline')
  static RuntimeCall getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<RuntimeCall>(create);
  static RuntimeCall? _defaultInstance;

  RuntimeCall_PalletOneof whichPalletOneof() => _RuntimeCall_PalletOneofByTag[$_whichOneof(0)]!;
  void clearPalletOneof() => clearField($_whichOneof(0));

  @$pb.TagNumber(1)
  Balance get balanceCall => $_getN(0);
  @$pb.TagNumber(1)
  set balanceCall(Balance v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set stakingCall(Staking v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set identityCall(Identity v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set utilityCall(Utility v) { setField(4, v); }
  @$pb.TagNumber(4)
...
class SigningInput extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SigningInput', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.Polymesh.Proto'), createEmptyInstance: create)
    ...
    ..aOM<RuntimeCall>(10, _omitFieldNames ? '' : 'runtimeCall', subBuilder: RuntimeCall.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(10)
  set runtimeCall(RuntimeCall v) { setField(10, v); }
  @$pb.TagNumber(10)
...
class SigningOutput extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SigningOutput', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.Polymesh.Proto'), createEmptyInstance: create)
