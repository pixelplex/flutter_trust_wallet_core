...
class PublicKeySignature extends $pb.GeneratedMessage {
  ...
  factory PublicKeySignature.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory PublicKeySignature.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PublicKeySignature', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.BitcoinV2.Proto'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PublicKeySignature copyWith(void Function(PublicKeySignature) updates) => super.copyWith((message) => updates(message as PublicKeySignature)) as PublicKeySignature;
  ...
  static $pb.PbList<PublicKeySignature> createRepeated() => $pb.PbList<PublicKeySignature>();
  @$core.pragma('dart2js:noInline')
  static PublicKeySignature getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<PublicKeySignature>(create);
...
class Input_InputBuilder extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(15)
  set babylonStakingTimelockPath($2.InputBuilder_StakingTimelockPath v) { setField(15, v); }
  @$pb.TagNumber(15)
  ...
  @$pb.TagNumber(16)
  set babylonStakingUnbondingPath($2.InputBuilder_StakingUnbondingPath v) { setField(16, v); }
  @$pb.TagNumber(16)
  ...
  @$pb.TagNumber(17)
  set babylonStakingSlashingPath($2.InputBuilder_StakingSlashingPath v) { setField(17, v); }
  @$pb.TagNumber(17)
  ...
  @$pb.TagNumber(18)
  set babylonUnbondingTimelockPath($2.InputBuilder_UnbondingTimelockPath v) { setField(18, v); }
  @$pb.TagNumber(18)
  ...
  @$pb.TagNumber(19)
  set babylonUnbondingSlashingPath($2.InputBuilder_UnbondingSlashingPath v) { setField(19, v); }
  @$pb.TagNumber(19)
...
class Input extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set outPoint($1.OutPoint v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class Output_OutputBuilder extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(15)
  set babylonStaking($2.OutputBuilder_StakingOutput v) { setField(15, v); }
  @$pb.TagNumber(15)
  ...
  @$pb.TagNumber(16)
  set babylonUnbonding($2.OutputBuilder_UnbondingOutput v) { setField(16, v); }
  @$pb.TagNumber(16)
  ...
  @$pb.TagNumber(17)
  set babylonStakingOpReturn($2.OutputBuilder_OpReturn v) { setField(17, v); }
  @$pb.TagNumber(17)
...
class ChainInfo extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(3)
  set hrp($core.String v) { $_setString(2, v); }
  @$pb.TagNumber(3)
...
enum TransactionBuilder_DustPolicy {
  fixedDustThreshold, 
  notSet
}
...
class TransactionBuilder extends $pb.GeneratedMessage {
  ...
  factory TransactionBuilder.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory TransactionBuilder.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static const $core.Map<$core.int, TransactionBuilder_DustPolicy> _TransactionBuilder_DustPolicyByTag = {
    10 : TransactionBuilder_DustPolicy.fixedDustThreshold,
    0 : TransactionBuilder_DustPolicy.notSet
  };
  static const $core.Map<$core.int, TransactionBuilder_ChainSpecific> _TransactionBuilder_ChainSpecificByTag = {
    20 : TransactionBuilder_ChainSpecific.zcashExtraData,
    0 : TransactionBuilder_ChainSpecific.notSet
  };
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TransactionBuilder', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.BitcoinV2.Proto'), createEmptyInstance: create)
    ..oo(0, [10])
    ..oo(1, [20])
    ...
    ..e<InputSelector>(5, _omitFieldNames ? '' : 'inputSelector', $pb.PbFieldType.OE, defaultOrMaker: InputSelector.SelectAscending, valueOf: InputSelector.valueOf, enumValues: InputSelector.values)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TransactionBuilder copyWith(void Function(TransactionBuilder) updates) => super.copyWith((message) => updates(message as TransactionBuilder)) as TransactionBuilder;
  ...
  static $pb.PbList<TransactionBuilder> createRepeated() => $pb.PbList<TransactionBuilder>();
  @$core.pragma('dart2js:noInline')
  static TransactionBuilder getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<TransactionBuilder>(create);
  static TransactionBuilder? _defaultInstance;

  TransactionBuilder_DustPolicy whichDustPolicy() => _TransactionBuilder_DustPolicyByTag[$_whichOneof(0)]!;
  void clearDustPolicy() => clearField($_whichOneof(0));

  TransactionBuilder_ChainSpecific whichChainSpecific() => _TransactionBuilder_ChainSpecificByTag[$_whichOneof(1)]!;
  ...
  @$pb.TagNumber(5)
  set inputSelector(InputSelector v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set feePerVb($fixnum.Int64 v) { $_setInt64(5, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set changeOutput(Output v) { setField(7, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set maxAmountOutput(Output v) { setField(8, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(10)
  set fixedDustThreshold($fixnum.Int64 v) { $_setInt64(8, v); }
  @$pb.TagNumber(10)
  ...
  @$pb.TagNumber(20)
  set zcashExtraData($3.TransactionBuilderExtraData v) { setField(20, v); }
  @$pb.TagNumber(20)
...
class Psbt extends $pb.GeneratedMessage {
  ...
  Psbt._() : super();
  factory Psbt.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory Psbt.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Psbt', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.BitcoinV2.Proto'), createEmptyInstance: create)
    ..a<$core.List<$core.int>>(1, _omitFieldNames ? '' : 'psbt', $pb.PbFieldType.OY)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Psbt copyWith(void Function(Psbt) updates) => super.copyWith((message) => updates(message as Psbt)) as Psbt;
  ...
  @$core.pragma('dart2js:noInline')
  static Psbt getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<Psbt>(create);
...
class SigningInput extends $pb.GeneratedMessage {
  ...
  static const $core.Map<$core.int, SigningInput_Transaction> _SigningInput_TransactionByTag = {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SigningInput', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.BitcoinV2.Proto'), createEmptyInstance: create)
    ..oo(0, [10, 11])
    ..p<$core.List<$core.int>>(1, _omitFieldNames ? '' : 'privateKeys', $pb.PbFieldType.PY)
    ..p<$core.List<$core.int>>(2, _omitFieldNames ? '' : 'publicKeys', $pb.PbFieldType.PY)
    ..aOM<ChainInfo>(3, _omitFieldNames ? '' : 'chainInfo', subBuilder: ChainInfo.create)
    ..aOB(4, _omitFieldNames ? '' : 'dangerousUseFixedSchnorrRng')
    ..aOM<TransactionBuilder>(10, _omitFieldNames ? '' : 'builder', subBuilder: TransactionBuilder.create)
  ...
  SigningInput_Transaction whichTransaction() => _SigningInput_TransactionByTag[$_whichOneof(0)]!;
  ...
  @$pb.TagNumber(3)
  set chainInfo(ChainInfo v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set dangerousUseFixedSchnorrRng($core.bool v) { $_setBool(3, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(10)
  set builder(TransactionBuilder v) { setField(10, v); }
  @$pb.TagNumber(10)
...
enum SigningOutput_Transaction {
  bitcoin, 
  zcash, 
  decred, 
  notSet
...
class SigningOutput extends $pb.GeneratedMessage {
  ...
  static const $core.Map<$core.int, SigningOutput_Transaction> _SigningOutput_TransactionByTag = {
  ...
  SigningOutput_Transaction whichTransaction() => _SigningOutput_TransactionByTag[$_whichOneof(0)]!;
  void clearTransaction() => clearField($_whichOneof(0));
  ...
  @$pb.TagNumber(5)
  set txid($core.List<$core.int> v) { $_setBytes(3, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(7)
  set weight($fixnum.Int64 v) { $_setInt64(5, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(15)
  set bitcoin($1.Transaction v) { setField(15, v); }
  @$pb.TagNumber(15)
  ...
  @$pb.TagNumber(16)
  set zcash($3.Transaction v) { setField(16, v); }
  @$pb.TagNumber(16)
  ...
  @$pb.TagNumber(17)
  set decred($4.Transaction v) { setField(17, v); }
  @$pb.TagNumber(17)
