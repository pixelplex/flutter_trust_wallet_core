...
class ParseRequestOutput extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ParseRequestOutput', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.WalletConnect.Proto'), createEmptyInstance: create)
    ...
    ..aOM<$11.SigningInput>(3, _omitFieldNames ? '' : 'binance', subBuilder: $11.SigningInput.create)
    ..aOM<$12.SigningInput>(4, _omitFieldNames ? '' : 'solana', subBuilder: $12.SigningInput.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $11.SigningInput get binance => $_getN(2);
  @$pb.TagNumber(3)
  set binance($11.SigningInput v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasBinance() => $_has(2);
  @$pb.TagNumber(3)
  void clearBinance() => clearField(3);
  @$pb.TagNumber(3)
  $11.SigningInput ensureBinance() => $_ensure(2);

  @$pb.TagNumber(4)
  $12.SigningInput get solana => $_getN(3);
  @$pb.TagNumber(4)
  set solana($12.SigningInput v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasSolana() => $_has(3);
  @$pb.TagNumber(4)
  void clearSolana() => clearField(4);
  @$pb.TagNumber(4)
  $12.SigningInput ensureSolana() => $_ensure(3);
}
