...
class OutPoint extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'OutPoint', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.DecredV2.Proto'), createEmptyInstance: create)
  ...
  @$pb.TagNumber(3)
  set tree($core.int v) { $_setUnsignedInt32(2, v); }
  @$pb.TagNumber(3)
...
class Transaction extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Transaction', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.DecredV2.Proto'), createEmptyInstance: create)
    ..a<$core.int>(1, _omitFieldNames ? '' : 'serializeType', $pb.PbFieldType.OU3)
...
class TransactionInput extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TransactionInput', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.DecredV2.Proto'), createEmptyInstance: create)
    ...
    ..a<$core.List<$core.int>>(6, _omitFieldNames ? '' : 'scriptSig', $pb.PbFieldType.OY)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(6)
  set scriptSig($core.List<$core.int> v) { $_setBytes(5, v); }
  @$pb.TagNumber(6)
...
class TransactionOutput extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TransactionOutput', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.DecredV2.Proto'), createEmptyInstance: create)
