...
const Balance$json = {
  '1': 'Balance',
  '2': [
    {'1': 'transfer', '3': 1, '4': 1, '5': 11, '6': '.TW.Polymesh.Proto.Balance.Transfer', '9': 0, '10': 'transfer'},
  ],
...
const Staking$json = {
  '1': 'Staking',
  '2': [
    {'1': 'bond', '3': 1, '4': 1, '5': 11, '6': '.TW.Polymesh.Proto.Staking.Bond', '9': 0, '10': 'bond'},
    {'1': 'bond_extra', '3': 2, '4': 1, '5': 11, '6': '.TW.Polymesh.Proto.Staking.BondExtra', '9': 0, '10': 'bondExtra'},
    {'1': 'unbond', '3': 3, '4': 1, '5': 11, '6': '.TW.Polymesh.Proto.Staking.Unbond', '9': 0, '10': 'unbond'},
    {'1': 'withdraw_unbonded', '3': 4, '4': 1, '5': 11, '6': '.TW.Polymesh.Proto.Staking.WithdrawUnbonded', '9': 0, '10': 'withdrawUnbonded'},
    {'1': 'nominate', '3': 5, '4': 1, '5': 11, '6': '.TW.Polymesh.Proto.Staking.Nominate', '9': 0, '10': 'nominate'},
    {'1': 'chill', '3': 6, '4': 1, '5': 11, '6': '.TW.Polymesh.Proto.Staking.Chill', '9': 0, '10': 'chill'},
    {'1': 'rebond', '3': 7, '4': 1, '5': 11, '6': '.TW.Polymesh.Proto.Staking.Rebond', '9': 0, '10': 'rebond'},
  ],
  '3': [Staking_Bond$json, Staking_BondExtra$json, Staking_Unbond$json, Staking_Rebond$json, Staking_WithdrawUnbonded$json, Staking_Nominate$json, Staking_Chill$json],
  '8': [
    {'1': 'message_oneof'},
  ],
};
...
final $typed_data.Uint8List identityIdDescriptor = $convert.base64Decode(
    'CgpJZGVudGl0eUlkEg4KAmlkGAEgASgMUgJpZA==');
...
final $typed_data.Uint8List assetIdDescriptor = $convert.base64Decode(
    'CgdBc3NldElkEg4KAmlkGAEgASgMUgJpZA==');

@$core.Deprecated('Use portfolioIdDescriptor instead')
const PortfolioId$json = {
  '1': 'PortfolioId',
  '2': [
    {'1': 'identity', '3': 1, '4': 1, '5': 11, '6': '.TW.Polymesh.Proto.IdentityId', '10': 'identity'},
...
const SecondaryKeyPermissions$json = {
  ...
  '2': [
    {'1': 'asset', '3': 1, '4': 1, '5': 11, '6': '.TW.Polymesh.Proto.SecondaryKeyPermissions.AssetPermissions', '10': 'asset'},
    {'1': 'extrinsic', '3': 2, '4': 1, '5': 11, '6': '.TW.Polymesh.Proto.SecondaryKeyPermissions.ExtrinsicPermissions', '10': 'extrinsic'},
    {'1': 'portfolio', '3': 3, '4': 1, '5': 11, '6': '.TW.Polymesh.Proto.SecondaryKeyPermissions.PortfolioPermissions', '10': 'portfolio'},
  ],
  '3': [SecondaryKeyPermissions_AssetPermissions$json, SecondaryKeyPermissions_PortfolioPermissions$json, SecondaryKeyPermissions_PalletPermissions$json, SecondaryKeyPermissions_ExtrinsicPermissions$json],
...
const SecondaryKeyPermissions_AssetPermissions$json = {
  '1': 'AssetPermissions',
  '2': [
    {'1': 'kind', '3': 1, '4': 1, '5': 14, '6': '.TW.Polymesh.Proto.SecondaryKeyPermissions.RestrictionKind', '10': 'kind'},
    {'1': 'assets', '3': 2, '4': 3, '5': 11, '6': '.TW.Polymesh.Proto.AssetId', '10': 'assets'},
  ],
};
...
const SecondaryKeyPermissions_PortfolioPermissions$json = {
  ...
  '2': [
    {'1': 'kind', '3': 1, '4': 1, '5': 14, '6': '.TW.Polymesh.Proto.SecondaryKeyPermissions.RestrictionKind', '10': 'kind'},
    {'1': 'portfolios', '3': 2, '4': 3, '5': 11, '6': '.TW.Polymesh.Proto.PortfolioId', '10': 'portfolios'},
  ],
};
...
const SecondaryKeyPermissions_PalletPermissions$json = {
  ...
  '2': [
    ...
    {'1': 'kind', '3': 2, '4': 1, '5': 14, '6': '.TW.Polymesh.Proto.SecondaryKeyPermissions.RestrictionKind', '10': 'kind'},
...
const SecondaryKeyPermissions_ExtrinsicPermissions$json = {
  ...
  '2': [
    {'1': 'kind', '3': 1, '4': 1, '5': 14, '6': '.TW.Polymesh.Proto.SecondaryKeyPermissions.RestrictionKind', '10': 'kind'},
    {'1': 'pallets', '3': 2, '4': 3, '5': 11, '6': '.TW.Polymesh.Proto.SecondaryKeyPermissions.PalletPermissions', '10': 'pallets'},
  ],
};
...
const Identity$json = {
  '1': 'Identity',
  '2': [
    {'1': 'join_identity_as_key', '3': 1, '4': 1, '5': 11, '6': '.TW.Polymesh.Proto.Identity.JoinIdentityAsKey', '9': 0, '10': 'joinIdentityAsKey'},
    {'1': 'add_authorization', '3': 2, '4': 1, '5': 11, '6': '.TW.Polymesh.Proto.Identity.AddAuthorization', '9': 0, '10': 'addAuthorization'},
    {'1': 'leave_identity_as_key', '3': 3, '4': 1, '5': 11, '6': '.TW.Polymesh.Proto.Identity.LeaveIdentityAsKey', '9': 0, '10': 'leaveIdentityAsKey'},
  ],
  '3': [Identity_JoinIdentityAsKey$json, Identity_LeaveIdentityAsKey$json, Identity_AddAuthorization$json],
  '8': [
    {'1': 'message_oneof'},
  ],
};
...
const Identity_AddAuthorization$json = {
  ...
  '2': [
    ...
    {'1': 'authorization', '3': 3, '4': 1, '5': 11, '6': '.TW.Polymesh.Proto.Identity.AddAuthorization.Authorization', '10': 'authorization'},
...
const Identity_AddAuthorization_Authorization$json = {
  '1': 'Authorization',
  '2': [
    {'1': 'join_identity', '3': 6, '4': 1, '5': 11, '6': '.TW.Polymesh.Proto.SecondaryKeyPermissions', '9': 0, '10': 'joinIdentity'},
  ],
  '8': [
    {'1': 'auth_oneof'},
  ],
...
const Utility$json = {
  '1': 'Utility',
  '2': [
    {'1': 'batch', '3': 1, '4': 1, '5': 11, '6': '.TW.Polymesh.Proto.Utility.Batch', '9': 0, '10': 'batch'},
  ],
...
const Utility_Batch$json = {
  '1': 'Batch',
  '2': [
    {'1': 'kind', '3': 1, '4': 1, '5': 14, '6': '.TW.Polymesh.Proto.Utility.BatchKind', '10': 'kind'},
    {'1': 'calls', '3': 2, '4': 3, '5': 11, '6': '.TW.Polymesh.Proto.RuntimeCall', '10': 'calls'},
...
const RuntimeCall$json = {
  '1': 'RuntimeCall',
  '2': [
    {'1': 'balance_call', '3': 1, '4': 1, '5': 11, '6': '.TW.Polymesh.Proto.Balance', '9': 0, '10': 'balanceCall'},
    {'1': 'staking_call', '3': 2, '4': 1, '5': 11, '6': '.TW.Polymesh.Proto.Staking', '9': 0, '10': 'stakingCall'},
    {'1': 'identity_call', '3': 3, '4': 1, '5': 11, '6': '.TW.Polymesh.Proto.Identity', '9': 0, '10': 'identityCall'},
    {'1': 'utility_call', '3': 4, '4': 1, '5': 11, '6': '.TW.Polymesh.Proto.Utility', '9': 0, '10': 'utilityCall'},
  ],
  '8': [
    {'1': 'pallet_oneof'},
  ],
...
const SigningInput$json = {
  ...
  '2': [
    ...
    {'1': 'runtime_call', '3': 10, '4': 1, '5': 11, '6': '.TW.Polymesh.Proto.RuntimeCall', '10': 'runtimeCall'},
  ],
};
