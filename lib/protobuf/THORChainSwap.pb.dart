...
class SwapOutput extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SwapOutput', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.THORChainSwap.Proto'), createEmptyInstance: create)
    ...
    ..aOM<$6.SigningInput>(4, _omitFieldNames ? '' : 'bitcoin', subBuilder: $6.SigningInput.create)
    ..aOM<$7.SigningInput>(5, _omitFieldNames ? '' : 'ethereum', subBuilder: $7.SigningInput.create)
    ..aOM<$11.SigningInput>(6, _omitFieldNames ? '' : 'binance', subBuilder: $11.SigningInput.create)
    ..aOM<$8.SigningInput>(7, _omitFieldNames ? '' : 'cosmos', subBuilder: $8.SigningInput.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  $6.SigningInput get bitcoin => $_getN(3);
  @$pb.TagNumber(4)
  set bitcoin($6.SigningInput v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasBitcoin() => $_has(3);
  @$pb.TagNumber(4)
  void clearBitcoin() => clearField(4);
  @$pb.TagNumber(4)
  $6.SigningInput ensureBitcoin() => $_ensure(3);

  @$pb.TagNumber(5)
  $7.SigningInput get ethereum => $_getN(4);
  @$pb.TagNumber(5)
  set ethereum($7.SigningInput v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set binance($11.SigningInput v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set cosmos($8.SigningInput v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasCosmos() => $_has(6);
  @$pb.TagNumber(7)
  void clearCosmos() => clearField(7);
  @$pb.TagNumber(7)
  $8.SigningInput ensureCosmos() => $_ensure(6);
}
