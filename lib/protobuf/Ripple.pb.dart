...
class OperationPayment extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'OperationPayment', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.Ripple.Proto'), createEmptyInstance: create)
    ...
    ..a<$fixnum.Int64>(4, _omitFieldNames ? '' : 'destinationTag', $pb.PbFieldType.OU6, defaultOrMaker: $fixnum.Int64.ZERO)
    ..hasRequiredFields = false
  ;
...
class OperationEscrowCreate extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'OperationEscrowCreate', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.Ripple.Proto'), createEmptyInstance: create)
    ...
    ..a<$fixnum.Int64>(3, _omitFieldNames ? '' : 'destinationTag', $pb.PbFieldType.OU6, defaultOrMaker: $fixnum.Int64.ZERO)
    ..a<$fixnum.Int64>(4, _omitFieldNames ? '' : 'cancelAfter', $pb.PbFieldType.OU6, defaultOrMaker: $fixnum.Int64.ZERO)
    ..a<$fixnum.Int64>(5, _omitFieldNames ? '' : 'finishAfter', $pb.PbFieldType.OU6, defaultOrMaker: $fixnum.Int64.ZERO)
...
class OperationEscrowCancel extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'OperationEscrowCancel', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.Ripple.Proto'), createEmptyInstance: create)
    ...
    ..a<$core.int>(2, _omitFieldNames ? '' : 'offerSequence', $pb.PbFieldType.OU3)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  set offerSequence($core.int v) { $_setUnsignedInt32(1, v); }
  @$pb.TagNumber(2)
...
class OperationNFTokenBurn extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set nftokenId($core.String v) { $_setString(0, v); }
  @$pb.TagNumber(1)
...
class OperationNFTokenAcceptOffer extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set sellOffer($core.String v) { $_setString(0, v); }
  @$pb.TagNumber(1)
...
class SigningInput extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SigningInput', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.Ripple.Proto'), createEmptyInstance: create)
    ...
    ..a<$core.int>(3, _omitFieldNames ? '' : 'lastLedgerSequence', $pb.PbFieldType.OU3)
    ..aOS(4, _omitFieldNames ? '' : 'account')
    ..a<$fixnum.Int64>(5, _omitFieldNames ? '' : 'flags', $pb.PbFieldType.OU6, defaultOrMaker: $fixnum.Int64.ZERO)
    ...
    ..a<$fixnum.Int64>(25, _omitFieldNames ? '' : 'sourceTag', $pb.PbFieldType.OU6, defaultOrMaker: $fixnum.Int64.ZERO)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  set lastLedgerSequence($core.int v) { $_setUnsignedInt32(2, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(20)
  set rawJson($core.String v) { $_setString(16, v); }
  @$pb.TagNumber(20)
  ...
  @$pb.TagNumber(25)
  set sourceTag($fixnum.Int64 v) { $_setInt64(17, v); }
  @$pb.TagNumber(25)
