...
class TransactionBuilderExtraData extends $pb.GeneratedMessage {
  ...
  factory TransactionBuilderExtraData.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory TransactionBuilderExtraData.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TransactionBuilderExtraData', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.Zcash.Proto'), createEmptyInstance: create)
    ..a<$core.List<$core.int>>(1, _omitFieldNames ? '' : 'branchId', $pb.PbFieldType.OY)
    ..a<$core.int>(2, _omitFieldNames ? '' : 'expiryHeight', $pb.PbFieldType.OU3)
  ...
  TransactionBuilderExtraData clone() => TransactionBuilderExtraData()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TransactionBuilderExtraData copyWith(void Function(TransactionBuilderExtraData) updates) => super.copyWith((message) => updates(message as TransactionBuilderExtraData)) as TransactionBuilderExtraData;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static TransactionBuilderExtraData create() => TransactionBuilderExtraData._();
  TransactionBuilderExtraData createEmptyInstance() => create();
  static $pb.PbList<TransactionBuilderExtraData> createRepeated() => $pb.PbList<TransactionBuilderExtraData>();
  @$core.pragma('dart2js:noInline')
  static TransactionBuilderExtraData getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<TransactionBuilderExtraData>(create);
  ...
  @$pb.TagNumber(1)
  set branchId($core.List<$core.int> v) { $_setBytes(0, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set expiryHeight($core.int v) { $_setUnsignedInt32(1, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set zip0317($core.bool v) { $_setBool(2, v); }
  @$pb.TagNumber(3)
...
class Transaction extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Transaction', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.Zcash.Proto'), createEmptyInstance: create)
    ...
    ..a<$core.List<$core.int>>(8, _omitFieldNames ? '' : 'branchId', $pb.PbFieldType.OY)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  set versionGroupId($core.int v) { $_setUnsignedInt32(1, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(6)
  set expiryHeight($core.int v) { $_setUnsignedInt32(5, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set saplingValueBalance($fixnum.Int64 v) { $_setInt64(6, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set branchId($core.List<$core.int> v) { $_setBytes(7, v); }
  @$pb.TagNumber(8)
