...
class TransactionInput extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TransactionInput', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.Decred.Proto'), createEmptyInstance: create)
    ..aOM<$6.OutPoint>(1, _omitFieldNames ? '' : 'previousOutput', protoName: 'previousOutput', subBuilder: $6.OutPoint.create)
  ...
  @$pb.TagNumber(1)
  set previousOutput($6.OutPoint v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class SigningOutput extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(6)
  set signingResultV2($5.SigningOutput v) { setField(6, v); }
  @$pb.TagNumber(6)
